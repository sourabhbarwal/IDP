      ...
      <main className="max-w-5xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link to="/cost"
            className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:border-primary-300 hover:shadow-md transition-all group">
            <div className="text-3xl mb-3">💰</div>
            <h3 className="font-semibold text-gray-800 group-hover:text-primary-600">Cost & Audit</h3>
            <p className="text-sm text-gray-500 mt-1">Resource costs, rightsizing, audit trail</p>
            <p className="text-xs text-primary-600 mt-3 font-medium">Open →</p>
          </Link>
          ...
          <Link to="/alerts"
            className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:border-primary-300 hover:shadow-md transition-all group">
            <div className="text-3xl mb-3">🔔</div>
            <h3 className="font-semibold text-gray-800 group-hover:text-primary-600">Alerts</h3>
            <p className="text-sm text-gray-500 mt-1">Active alerts, rules, acknowledgement</p>
            <p className="text-xs text-primary-600 mt-3 font-medium">Open →</p>
          </Link>
          ...
          <Link to="/copilot"
            className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:border-primary-300 hover:shadow-md transition-all group">
            <div className="text-3xl mb-3">🤖</div>
            <h3 className="font-semibold text-gray-800 group-hover:text-primary-600">AI Copilot</h3>
